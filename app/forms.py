...
class MypasswordChangeForm(PasswordChangeForm):
    ...
    new_password2=forms.CharField(label=_("Conifirm Name Password"),strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password','class':'form-control'}))
